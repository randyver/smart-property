...
export default function ClimateScores({
  ...
  const scoreExplanations = {
    lst_score:
      "Land Surface Temperature - Menunjukkan suhu permukaan tanah di sekitar properti",
    ndvi_score:
      "Normalized Difference Vegetation Index - Mengukur ketersediaan ruang hijau di sekitar properti",
    utfvi_score:
      "Urban Thermal Field Variance Index - Mengukur variasi suhu perkotaan",
    uhi_score:
      "Urban Heat Island - Mengukur efek pulau panas perkotaan di sekitar properti",
    overall_score:
      "Overall Climate Score - Skor keseluruhan keamanan iklim properti",
  };
