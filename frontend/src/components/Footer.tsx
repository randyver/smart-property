      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-gray-400 hover:text-smartproperty">Home</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex space-x-4 mt-4">
                <Link href="/" className="text-gray-400 hover:text-smartproperty">
                ...
                <Link href="/" className="text-gray-400 hover:text-smartproperty">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M12 2.25c-5.36 0-9.75 4.39-9.75 9.75S6.64 21.75 12 21.75s9.75-4.39 9.75-9.75S17.36 2.25 12 2.25zm0 17.25a7.5 7.5 0 1 1 .001-15.001A7.5 7.5 0 0 1 12 19.5z" />
                    <path d="M16.88 7.12a1.5 1.5 0 1 1-2.121-2.121l3-3a1.5 1.5 0 0 1 2.121 2.121l-3 3z" />
                  </svg>
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 SmartProperty. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/" className="text-gray-400 hover:text-smartproperty text-sm">Terms of Service</Link>
            <Link href="/" className="text-gray-400 hover:text-smartproperty text-sm">Privacy Policy</Link>
            <Link href="/" className="text-gray-400 hover:text-smartproperty text-sm">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
