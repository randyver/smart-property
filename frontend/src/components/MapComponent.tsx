// Updated MapComponent.tsx with improved layer handling
"use client";
...
const MapComponent = memo(
  ({
    ...
    // Layer information with colors and descriptions
    const layerConfig = useMemo(() => ({
      ...
      ndvi: {
        ...
        colors: [
          ...
          "#91cf60", // gridcode 2 - Moderate Vegetation
          "#fee08b", // gridcode 3 - Low Vegetation
          "#fc8d59", // gridcode 4 - Very Low Vegetation
          "#d73027"  // gridcode 5 - No Vegetation (Worse)
        ],
        legend: [
      ...
      uhi: {
        ...
        colors: [
          ...
          "#fee08b", // gridcode 2 - Moderate
          "#fc8d59", // gridcode 3 - Significant
          "#d73027"  // gridcode 4 - Severe (Worse)
        ],
        legend: [
    ...
    useEffect(() => {
      ...
      const loadClimateLayer = async (layerType: ClimateLayerType) => {
        ...
        try {
          ...
          if (!response.ok) {
            throw new Error(`Failed to load ${layerType} data: ${response.statusText}`);
          }
          ...
          map.addLayer({
            ...
            paint: {
              "fill-color": [
                "match",
                ["get", "gridcode"],
                1, layerInfo.colors[0],
                2, layerInfo.colors[1],
                3, layerInfo.colors[2],
                4, layerInfo.colors[3],
                5, layerInfo.colors.length >= 5 ? layerInfo.colors[4] : layerInfo.colors[3],
